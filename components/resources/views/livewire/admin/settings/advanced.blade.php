		...
		<div class="col-12 mb-4">
			<div class="card">
				<div class="card-body">
					...
					<small class="form-hint">{{ __('Add custom scripts inside HEAD tag. You need to have') }} <code class="font-weight-bold">{{ __('SCRIPT') }}</code> {{ __('or') }} <code class="font-weight-bold">{{ __('STYLE') }}</code> {{ __('tag around scripts.') }}</small>
		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					...
					<small class="form-hint">{{ __('Add custom scripts you might want to be loaded in the footer of your website. You need to have') }} <code class="font-weight-bold">{{ __('SCRIPT') }}</code> {{ __('or') }} <code class="font-weight-bold">{{ __('STYLE') }}</code> {{ __('tag around scripts.') }}</small>
