                ...
                <div class="form-group">
                    <button class="btn bg-gradient-info mx-auto d-block" wire:loading.attr="disabled">
                        <span>
                            ...
                            <span wire:target="onDomainAgeChecker">{{ __('Check') }}</span>
                        </span>
                    </button>
                </div>
            </div>
        ...
        @if ( !empty($data) )
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover border">
                   ...
                   <tbody>
                           <tr>
                               <td class="border">{{ $data['domain_name'] }}</td>
                               <td class="border">{{ $data['age'] }}</td>
                               <td class="border">{{ date("Y-m-d", $data['creation_date']) }}</td>
                               <td class="border">{{ date("Y-m-d", $data['updated_date']) }}</td>
                               <td class="border">{{ date("Y-m-d", $data['expiration_date']) }}</td>
                           </tr>
                   </tbody>
                </table>
            </div>
