<div>
      ...
      <form wire:submit.prevent="onYoutubeChannelBannerDownloader">
        ...
        <div>
                    ...
                    <div class="form-group">
                        <button class="btn bg-gradient-info mx-auto d-block" wire:loading.attr="disabled">
                            <span>
                                ...
                                <span wire:target="onYoutubeChannelBannerDownloader">{{ __('Download') }}</span>
                            </span>
                        </button>
                    </div>
                </div>
            ...
            @if ( !empty($data) )
                <div class="form-group text-center mx-auto mb-2">
                    <a class="btn bg-gradient-success download-image" href="{{ $data['download'] }}" download>
                        <i class="fas fa-download text-white me-1"></i>
                        {{ __('Download Image') }}
                    </a>
                </div>
               <img src="{{ $data['preview'] }}" class="img-thumbnail">
            @endif
