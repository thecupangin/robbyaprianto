<div>
      ...
      <form wire:submit.prevent="onServerStatusChecker">
            ...
            <div class="col-auto">
                <div class="form-group">
                    <button class="btn bg-gradient-info mx-auto d-block" wire:loading.attr="disabled">
                        <span>
                            <div wire:loading.inline wire:target="onServerStatusChecker">
                                <x-loading />
                            </div>
                            <span wire:target="onServerStatusChecker">{{ __('Check') }}</span>
                        </span>
                    </button>
                </div>
            </div>
                ...
                <table class="table table-bordered table-hover border">
                   ...
                   <tbody>
                           <tr>
                               ...
                               <td class="border">{{ $data['http_code'] }}</td>
