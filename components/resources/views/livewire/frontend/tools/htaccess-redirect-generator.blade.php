        ...
        <div class="row">
            ...
            <div class="col">
                <div class="input-group input-group-flat mb-3">
                    <input type="text" class="form-control" wire:model="domain" placeholder="example.com" required />
                ...
                <div class="input-group">
                    <h6 class="d-block w-100">{{ __('Select redirect type:') }}</h6>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="type" id="nonwww" value="nonwww" wire:model="type">
                      <label class="form-check-label" for="nonwww">{{ __('Redirect from www to non-www') }}</label>
                    </div>

                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="type" id="www" value="www" wire:model="type">
