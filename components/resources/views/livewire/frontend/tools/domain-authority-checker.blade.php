<div>
      ...
      <form wire:submit.prevent="onDomainAuthorityChecker">
            ...
            <div class="col-auto">
                <div class="form-group">
                    <button class="btn bg-gradient-info mx-auto d-block" wire:loading.attr="disabled">
                        <span>
                            <div wire:loading.inline wire:target="onDomainAuthorityChecker">
                                <x-loading />
                            </div>
                            <span wire:target="onDomainAuthorityChecker">{{ __('Check') }}</span>
                        </span>
                    </button>
                </div>
            </div>
