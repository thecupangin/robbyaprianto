<div>
      ...
      <form wire:submit.prevent="onPageSizeChecker">
            ...
            <div class="col-auto">
                <div class="form-group">
                    <button class="btn bg-gradient-info mx-auto d-block" wire:loading.attr="disabled">
                        <span>
                            <div wire:loading.inline wire:target="onPageSizeChecker">
                                <x-loading />
                            </div>
                            <span wire:target="onPageSizeChecker">{{ __('Check') }}</span>
                        </span>
                    </button>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered border">
                    <thead class="bg-gradient-success text-white">
                        <tr>
                            <th>{{ __('URLs') }}</th>
                            <th>{{ __('Page Size (Bytes)') }}</th>
                            <th>{{ __('Page Size (KB)') }}</th>
                        </tr>
                    </thead>
                    <tbody>
                        @if ( !empty($data) )
