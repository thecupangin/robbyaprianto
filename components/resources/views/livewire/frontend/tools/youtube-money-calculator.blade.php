      ...
      <form wire:submit.prevent="onYoutubeMoneyCalculator">
            ...
            <div class="form-group">
                ...
                <div class="input-group input-group-flat">
                    <input type="number" class="form-control" wire:model="views" required />
                </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" wire:model="cpm_min" disabled />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" wire:model="cpm_max" disabled />
                        </div>
                    </div>
                </div>
            ...
            @if ( !empty($data) )
               <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr class="bg-gradient-success text-white text-bold">
