<div>
      ...
      <form wire:submit.prevent="onDaPaCheckerClass">
            ...
            <div class="col-auto">
                <div class="form-group">
                    <button class="btn bg-gradient-info mx-auto d-block" wire:loading.attr="disabled">
                        <span>
                            <div wire:loading.inline wire:target="onDaPaCheckerClass">
                                <x-loading />
                            </div>
                            <span wire:target="onDaPaCheckerClass">{{ __('Check') }}</span>
                        </span>
                    </button>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover border">
                   <thead class="bg-gradient-success text-white">
                       <tr>
                           <th>{{ __('URL') }}</th>
                           <th>{{ __('Domain Authority') }}</th>
                           <th>{{ __('Page Authority') }}</th>
                   ...
                   <tbody>
                           <tr>
                               ...
                               <td class="border">{{ $data['domain_authority'] }}</td>
                               <td class="border">{{ $data['page_authority'] }}</td>
                               <td class="border">{{ $data['linking_domains'] }}</td>
                               <td class="border">{{ $data['total_links'] }}</td>
                           </tr>
                   </tbody>
                </table>
            </div>
