      ...
      <form wire:submit.prevent="onYoutubeTrend">
        ...
        <div class="row">
            ...
            <div class="form-group mb-3 row">
                ...
                <div class="col">
                    <select class="form-control form-select" wire:model="lang" required>
                   ...
                   <tbody>
                        @foreach ($data as $key => $value)
                           <tr>
                               ...
                               <td class="border"><img src="{{ $value['thumbnail'] }}" class="img-fluid img-thumbnail" alt="{{ $value['title'] }}"></td>
                               <td class="border"><a href="{{ $value['link'] }}" title="{{ $value['title'] }}">{{ $value['title'] }}</a></td>
                               <td class="border">
