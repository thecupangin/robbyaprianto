      ...
      <form wire:submit.prevent="onYoutubeChannelSearch">
        ...
        <div class="row">
            ...
            <div class="form-group mb-3 row">
                ...
                <div class="col">
                    <input type="text" class="form-control" placeholder="seo" wire:model="query" required />
                </div>
            </div>
            ...
            <div class="form-group mb-3 row">
                ...
                <div class="col">
                    <input type="number" class="form-control" wire:model="result" required />
                </div>
            </div>
        ...
        @if ( !empty($data) )
            ...
            <div class="card">
                <div class="card-header bg-success text-center text-white text-bold p-3">
                    <h6 class="text-white mb-0">{{ __('Results') }}</h6>
                </div>
                            ...
                            <div class="col-12 col-md-6 mb-2">
                                <div class="card p-2">
                                    <div class="author align-items-center">
                                      <img src="{{ $value['thumbnail'] }}" alt="{{ __('Channel Logo') }}" class="avatar shadow">
                                      <div class="name ps-3">
                                        <span><a href="https://www.youtube.com/channel/{{ $value['channelId'] }}" target="_blank">{{ $value['channelTitle'] }}</a></span>
                                        <div class="stats">
                                          <small>{{ __('Published on') }} {{ $value['publishedAt'] }}</small>
                                        </div>
                                      </div>
                                    </div>
                                </div>
