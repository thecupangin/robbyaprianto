<div>
      ...
      <form wire:submit.prevent="onPageAuthorityChecker">
            ...
            <div class="col-auto">
                <div class="form-group">
                    <button class="btn bg-gradient-info mx-auto d-block" wire:loading.attr="disabled">
                        <span>
                            <div wire:loading.inline wire:target="onPageAuthorityChecker">
                                <x-loading />
                            </div>
                            <span wire:target="onPageAuthorityChecker">{{ __('Check') }}</span>
                        </span>
                    </button>
                </div>
            </div>
