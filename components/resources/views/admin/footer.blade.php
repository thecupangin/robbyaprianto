...
<head>
    ...
    <title>{{ __('Footer - SumoSEOTools') }}</title>
                  ...
                  <div class="row">
                    <div class="col">
                        ...
                        @switch(true)
                           ...
                           @case( Route::is('create-footer-translations') )
                                    @livewire('admin.settings.footer.create')
                                @break

                           @case( Route::is('edit-footer-translations') )
                                    @livewire('admin.settings.footer.edit', ['trans_id' => request()->route('trans_id')])
                                @break

                            @default
                                    @livewire('admin.settings.footer')
                        @endswitch
