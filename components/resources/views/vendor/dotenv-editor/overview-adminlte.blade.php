      ...
      <div class="col-md-12 col-sm-12">
        ...
        <div v-show="views[0].active">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <p>
                <a href="javascript:;" v-show="loadButton" class="btn bg-gradient-primary" @click="loadEnv">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="button" class="btn bg-gradient-default" data-dismiss="modal">
                    {!! __('dotenv-editor::views.overview_delete_modal_no') !!}
                  </button>
                  <button type="button" class="btn bg-gradient-danger" @click="deleteEntry">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn bg-gradient-primary" @click="updateEntry">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form @submit.prevent="addNew()">
                ...
                <button class="btn bg-gradient-default" type="submit">
        ...
        <div v-show="views[2].active">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <a href="{{ url(config('dotenveditor.route.prefix') . "/createbackup") }}" class="btn bg-gradient-primary">
                {!! __('dotenv-editor::views.backup_create') !!}
              </a>
              <a href="{{ url(config('dotenveditor.route.prefix') . "/download") }}" class="btn bg-gradient-primary">
            ...
            <div class="table-responsive">
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn bg-gradient-success" href="javascript:;" @click="showBackupDetails('{{ $backup['unformatted'] }}', '{{ $backup['formatted'] }}')" title="{!! __('dotenv-editor::views.backup_table_options_show') !!}">
                      <span class="fa fa-search-plus"></span>
                    </a>
                    <a class="btn bg-gradient-warning" href="javascript:;" @click="restoreBackup({{ $backup['unformatted'] }})" title="{!! __('dotenv-editor::views.backup_table_options_restore') !!}">
                      <span class="fa fa-refresh" title="{!! __('dotenv-editor::views.backup_table_options_restore') !!}"></span>
                    </a>
                    <a class="btn bg-gradient-info" href="{{ url(config('dotenveditor.route.prefix') . "/download/" . $backup['unformatted']) }}">
                      <span class="fa fa-download" title="{!! __('dotenv-editor::views.backup_table_options_download') !!}"></span>
                    </a>
                    <a onclick="return confirm('are you sure?')" class="btn bg-gradient-danger" href="{{ url(config('dotenveditor.route.prefix') . "/deletebackup/" . $backup["unformatted"]) }}" title="{!! __('dotenv-editor::views.backup_table_options_delete') !!}">
          ...
          <div class="modal fade" id="showDetails" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <a href="javascript:;" @click="restoreBackup(currentBackup.timestamp)" title="Stelle dieses Backup wieder her" class="btn bg-gradient-primary">
                    {!! __('dotenv-editor::views.backup_modal_restore') !!}
                  </a>

                  <button type="button" class="btn bg-gradient-default" data-dismiss="modal">{!! __('dotenv-editor::views.backup_modal_close') !!}</button>

                  <a onclick="return confirm('are you sure?')" href="{{ url(config('dotenveditor.route.prefix') . "/deletebackup/" . $backup["unformatted"]) }}" class="btn bg-gradient-danger">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form method="post" action="{{ url(config('dotenveditor.route.prefix') . "/upload") }}" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn bg-gradient-primary" title="Ein Backup von deinem Computer hochladen">
