...
namespace App\Http\Livewire\Admin\Pages\Posts;
...
class Showlist extends Component
{
    ...
    {
        return view('livewire.admin.pages.posts.showlist', [
            'default_lang'         => Languages::where('default', true)->first()->code,
            'pages'                => Page::where('slug', 'like', '%'.$this->searchQuery.'%')->whereIn('type', ['post'])->orderBy('id', 'DESC')->paginate(15),
