...
class Showlist extends Component
{
    ...
    public function render()
    {
        return view('livewire.admin.pages.translations.showlist', [
            ...
            'page_id'           => $this->pageID,
            'slug'              => ( Page::where('id', $this->pageID)->first()->type != 'home' && Page::where('id', $this->pageID)->first()->tool_name != 'custom_tool_link' ) ? Page::where('id', $this->pageID)->first()->slug : '',
            'type'              => ( Page::where('id', $this->pageID)->first()->type != 'home' ) ? Page::where('id', $this->pageID)->first()->type : ''
        ]);
    }
