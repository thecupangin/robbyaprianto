...
class Create extends Component
{
    ...
    {
		$this->reset(['page_title', 'title', 'subtitle', 'short_description', 'description']);
    }
    ...
    public function onCreatePageTranslation()
    {
        ...
        try {
            ...
            if ( $page->hasTranslation(app()->getLocale()) == true ) {
                ...
                $page->translateOrNew(app()->getLocale())->page_title        = !empty($this->page_title[app()->getLocale()]) ? strip_tags($this->page_title[app()->getLocale()]) : '';
