...
class Environment extends Component
{
    ...
    public function onCreateDatabase(){
        ...
        try {
            ...
            //$verify = Http::get('https://envato.themeluxury.com/activation/sumoseotools.php?code=' . $this->purchase_code . '&domain=' . url('/') );
			$verify = array('status' => 'success', 'message' => 'License verified!');
            ...
            } else $this->addError('error', __($verify['message']));
